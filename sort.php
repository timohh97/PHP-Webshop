  ...
  <div id="preisspanne">
        ...
        if($_SESSION["category"]=="all" || is_null($_SESSION["category"]))
        {
            ...
            else
            {
                ...
                $query = "SELECT * FROM shop WHERE price BETWEEN '$min' AND '$max' ORDER BY price";
            }
        ...
        else
        {
            ...
            if(is_null($_SESSION["minprice"]))
            {
                $query = "SELECT * FROM shop WHERE category='".$_SESSION["category"]."' ORDER BY price";
            }
            else
            {
                $min = $_SESSION["minprice"];
                $max = $_SESSION["maxprice"];
                   ...
                   $query = "SELECT * FROM shop WHERE price BETWEEN '$min' AND '$max' AND category='".$_SESSION["category"]."' ORDER BY price"; 
